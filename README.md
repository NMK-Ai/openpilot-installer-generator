...
- If `branch` is left blank (https://nmk.sa/fork/commaai), git will clone the default branch on GitHub.
...
**Example:** https://nmk.sa/fork/nmk installs the Stock Additions fork.
...
- To install [dragonpilot](https://github.com/NMK-Ai/NMK), you can simply use the following URL which uses the `beta2` branch by default: https://NMK-Ai/fork/beta2
- To install [Stock Additions](https://github.com/NMK-Ai/NMK), my fork, enter the URL: https://NMK.sa/fork/beta2
- To install [stock openpilot](https://github.com/commaai/openpilot), enter the URL: https://NMK-AI/fork/NMK_KSA or just https://nmk.sa/fork
